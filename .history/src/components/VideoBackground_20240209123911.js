...
const VideoBackground = ({ movie_id }) => {
    ...
    return (
        <div className='w-screen'>
            <iframe className='w-screen aspect-video' src={`${YOUTUBE_TRAILER}/${trailerVideo?.key}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write;  "></iframe>
        </div>
    )
}
