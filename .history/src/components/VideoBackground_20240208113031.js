...
const VideoBackground = ({ movie_id }) => {
    ...
    const trailerVideo = useSelector(store=>store?.movies?.trailerVideo?.id);
    ...
    return (
        <div>
            <iframe src={`${YOUTUBE_TRAILER}/${trailerId}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        </div>
    )
}
