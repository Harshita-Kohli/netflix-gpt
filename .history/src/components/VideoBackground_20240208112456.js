...
const VideoBackground = ({ movie_id }) => {
    ...
    return (
        <div>
            <irame src={`${YOUTUBE_TRAILER}+/+${trailer.key}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        </div>
    )
}
