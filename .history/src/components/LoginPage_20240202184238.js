                ...
                createUserWithEmailAndPassword(auth, email.current.value, password.current.value)
                    .then((userCredential) => {
                        ...
                        updateProfile(auth.user, {
                            displayName: "name.current.value", photoURL: "https://avatars.githubusercontent.com/u/54809528?v=4"
                        }).then(() => {
                            //we need to exctract the uid,email, name and photoURL from the auth object since it holds the updates value of the user
