...
const VideoBackground = ({ movie_id }) => {
    ...
    return (
        <div>
            <iframe src="https://www.youtube.com/embed/CHKn-yDCE2w?si=WVW4rYIR4_h1GnHA" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        </div>
    )
}
