...
const VideoBackground = ({ movie_id }) => {
    ...
    return (
        <div>
            <iframe src={`${YOUTUBE_TRAILER}/${trailer}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        </div>
    )
}
