    ...
    return (
        <div>
            ...
            <form className="w-3/12 bg-black/80 absolute p-12 my-36 mx-auto left-0 right-0 bg-opacity-60 rounded-md">
                ...
                {!isSignInForm &&
                    <input
                        type="password" placeholder="Confirm Password" class="p-2 mx-auto my-2 rounded-md w-full bg-gray-800" />}<button className="p-2 m-4 mx-auto bg-red-700 left-0 right-0 w-full rounded-md">{isSignInForm ? "Sign In" : "Sign Up"}</button>
