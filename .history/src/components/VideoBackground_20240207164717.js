...
const VideoBackground = ({ movie_id }) => {
    ...
    return (
        <div><iframe width="560" height="315" src="https://www.youtube.com/embed/CHKn-yDCE2w?si=WVW4rYIR4_h1GnHA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        VideoBackground</div>
    )
}
