...
const Header = () => {
    return (
        <div className='absolute px-8 py-2 bg-gradient-to-b from-black z-50 w-screen flexm '>
            ...
            <div className='flex p-2'><img src="" alt="userIcon" className='flex p-2'/>(Sign Out)</div>
        </div>
